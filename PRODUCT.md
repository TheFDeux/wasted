...
## Product Purpose
Wasted turns taste preferences into three niche cocktail recommendations, then hands over the full recipe and lets the user keep a shortlist. Success: the user finds a drink they had never heard of and actually makes or orders it.
...
- Quiz answers are weighted against a tagged catalogue of ~45 cocktails; top 3 are chosen with distinct base spirits where possible.
...
## Brand Commitments
Name: Wasted. Binding visual constraint from the brief: modern, yellow-orange tones.
